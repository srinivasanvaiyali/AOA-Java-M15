...
4.Depth-First Search (DFS) with Branch and Bound (dfs()): If the current path exceeds the budget or bound ≤ current best → prune the branch. Otherwise, recursively explore: Including the current startup (if it fits). Excluding the current startup. Update best whenever a higher profit is found.

5.Output: After exploring all feasible combinations, print the maximum profit best.  
...
## Output:
<img width="508" height="234" alt="512246373-457902e3-ee50-492b-88c7-4bf952af8c60" src="https://github.com/user-attachments/assets/37dc7cb1-f5b2-424e-814c-36b68e1f307e" />
